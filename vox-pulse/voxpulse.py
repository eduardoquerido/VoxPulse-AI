...
class VoxPulseCrew:
    ...
    def analyst(self) -> Agent:
        return Agent(
            config={
                ...
                "goal": "Analyze the sentiment of the data and categorize by theme",
    ...
    def research_task(self) -> Task:
        return Task(
            description="Search for the top 10 recent news regarding {politician} in Brazil.",
    ...
    def analysis_task(self) -> Task:
        return Task(
            description="Analyze the sentiment (0-100) and identify themes (Economy, Health, etc.).",
